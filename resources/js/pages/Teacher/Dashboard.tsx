                        ...
                        <div className="bg-red-50 dark:bg-red-900/20 border border-red-400 dark:border-red-800 text-red-700 dark:text-red-400 px-4 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl">
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs sm:text-sm mt-0.5">This dashboard is only accessible to teachers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
                    ...
                    <div className="mb-4 sm:mb-6 md:mb-8 border-b dark:border-gray-700 pb-3 sm:pb-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-1 sm:mb-2">Teacher Dashboard</h1>
                                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Quick overview of your current academic workload.</p>
                            </div>
                            <button 
                                onClick={fetchDashboardData}
                                className={`inline-flex items-center px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 ${TEXT_COLOR_CLASS} rounded-lg sm:rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-sm text-xs sm:text-sm md:text-base`}
                                disabled={loading}
                            >
                    ...
                    <div className="bg-white dark:bg-gray-800 dark:border-gray-700 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-700 space-y-3 sm:space-y-4 mb-4 sm:mb-6 md:mb-8">
                        <h2 className={`text-lg sm:text-xl font-bold ${TEXT_COLOR_CLASS} dark:text-white flex items-center`}>
                            <BookOpen className={`h-5 w-5 sm:h-6 sm:w-6 mr-2 ${TEXT_COLOR_CLASS} dark:text-white`} />
                            Quick Navigation
                        </h2>
