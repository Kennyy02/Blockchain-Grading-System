                    ...
                    <div className="mb-4 sm:mb-6 md:mb-8 border-b dark:border-gray-700 pb-3 sm:pb-4">
                        <div className="flex items-center justify-between">
                            ...
                            <button 
                                ...
                                className={`inline-flex items-center px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-white ${TEXT_COLOR_CLASS} rounded-lg sm:rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-sm text-xs sm:text-sm md:text-base`}
                                disabled={loading}
                            >
