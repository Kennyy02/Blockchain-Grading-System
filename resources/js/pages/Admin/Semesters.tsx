...
const Semesters: React.FC = () => {
    ...
    const handleView = (semesterItem: Semester) => {
        setSelectedSemester(semesterItem);
        ...
        <AppLayout>
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-900">
                <div className="container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-6 mb-4 sm:mb-6">
                        <div className="bg-white dark:bg-transparent rounded-lg sm:rounded-2xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-100 dark:border-white md:col-span-2">
                            ...
                            <div className="flex flex-col items-center text-center md:hidden">
                                <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-white mb-1 sm:mb-2">Current Semester</p>
                            ...
                            <div className="hidden md:flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium text-gray-600 dark:text-white mb-1">Current Semester</p>
                        ...
                        <div className="bg-white dark:bg-transparent rounded-lg sm:rounded-2xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-100 dark:border-white">
                            ...
                            <div className="hidden md:flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium text-gray-600 dark:text-white mb-1">Total Semesters</p>
                    ...
                    {/* Table - Responsive: Mobile shows Semester Name + Actions, Desktop shows all columns */}
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-white">
                                <thead className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-900 dark:border-white">
                                    <tr>
                                        <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 dark:text-white uppercase tracking-wider whitespace-nowrap">Semester Name</th>
                                        <th className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 dark:text-white uppercase tracking-wider whitespace-nowrap">Academic Year</th>
                                        <th className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 dark:text-white uppercase tracking-wider whitespace-nowrap">Dates</th>
                                        ...
                                        <th className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 dark:text-white uppercase tracking-wider whitespace-nowrap">Grades</th>
                                        ...
                                        <tr>
                                            <td colSpan={6} className="px-3 sm:px-6 py-8 sm:py-12 text-center text-gray-500 dark:text-white">
                                                <div className="flex flex-col items-center">
                                                    <Layers className="h-10 w-10 sm:h-12 sm:w-12 text-gray-300 dark:text-white mb-3 sm:mb-4" />
                                                    <p className="text-base sm:text-lg font-medium dark:text-white">No semesters found</p>
                                                    <p className="text-xs sm:text-sm dark:text-white">Create a new semester or adjust filters</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : (
                                        semesters.map((semesterItem) => (
                                            <tr key={semesterItem.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4">
                                                    <div className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white truncate">{semesterItem.semester_name}</div>
                                                    {/* Show additional info on mobile */}
                                                    <div className="md:hidden mt-1 space-y-1">
                                                        <div className="text-xs text-gray-600 dark:text-white">{semesterItem.academic_year.year_name}</div>
                                                        <div className="text-xs text-gray-600 dark:text-white">{formatShortDate(semesterItem.start_date)} - {formatShortDate(semesterItem.end_date)}</div>
                                                        <div className="flex items-center gap-2">
                                                            <span className="text-xs text-gray-600 dark:text-white">{semesterItem.classes_count} classes</span>
                                                            <span className="text-xs text-gray-600 dark:text-white">•</span>
                                                            <span className="text-xs text-gray-600 dark:text-white">{semesterItem.grades_count} grades</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-700 dark:text-white">{semesterItem.academic_year.year_name}</td>
                                                <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
                                                    <div className='text-xs sm:text-sm text-gray-700 dark:text-white'>{formatShortDate(semesterItem.start_date)} -</div>
                                                    <div className='text-xs text-gray-500 dark:text-white'>{formatShortDate(semesterItem.end_date)}</div>
                                                </td>
                                                <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-700 dark:text-white">{semesterItem.classes_count}</td>
                                                <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-700 dark:text-white">{semesterItem.grades_count}</td>
                                                <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-right">
                                                    <div className="flex justify-end space-x-1 sm:space-x-2">
                                                        <button
                                                            onClick={() => handleView(semesterItem)}
