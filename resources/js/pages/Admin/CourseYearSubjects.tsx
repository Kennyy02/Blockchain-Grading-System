            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-3 sm:p-4 md:p-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 border border-gray-100 dark:border-gray-700">
                    <div className="flex items-center">
                        <Search className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 dark:text-gray-400 mr-2 sm:mr-3" />
                        <input
                            type="text"
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)}
                            className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 ${RING_COLOR_CLASS} text-sm sm:text-base`}
                            ...
                            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                                {loading ? (
                                    <tr>
                                        <td colSpan={5} className="px-3 sm:px-6 py-8 sm:py-12 text-center">
                                            <div className="flex flex-col items-center">
                                                <RefreshCw className="h-6 w-6 sm:h-8 sm:w-8 animate-spin text-gray-400 dark:text-gray-400 mb-2" />
                                    ...
                                    <tr>
                                        <td colSpan={5} className="px-3 sm:px-6 py-8 sm:py-12 text-center">
                                            <div className="flex flex-col items-center">
                                                <GraduationCap className="h-10 w-10 sm:h-12 sm:w-12 text-gray-300 dark:text-gray-500 mb-3 sm:mb-4" />
                                                <p className={`${TEXT_COLOR_CLASS} dark:text-white font-medium text-base sm:text-lg`}>No courses with curriculum</p>
                                                <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">Add subjects to courses to see them here</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                    filteredCourses.map((course) => (
                                        <tr key={course.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                            ...
                                            <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-center">
                                                ...
                                                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 ml-1">subjects</span>
                                            </td>
                                            <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-center">
                                                <span className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">{course.total_units}</span>
                                                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 ml-1">units</span>
                                            </td>
