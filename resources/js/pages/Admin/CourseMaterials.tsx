                    ...
                    <div className="p-6 dark:bg-gray-800">
                        ...
                        <div className="flex items-center mb-6 pb-6 border-b dark:border-gray-700">
                            <div className={`${LIGHT_BG_CLASS} dark:bg-gray-700 p-4 rounded-full mr-4`}>
                                <IconComponent className={`h-12 w-12 ${TEXT_COLOR_CLASS} dark:text-white`} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{material.title}</h3>
                                <p className="text-gray-500 dark:text-gray-400">{material.subject?.subject_code} - {material.subject?.subject_name}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <p className="text-gray-900 dark:text-white font-medium mt-1">{material.title}</p>
                            </div>
                            <div>
                                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Subject</label>
                                <p className="text-gray-900 dark:text-white font-medium mt-1">{material.subject?.subject_code} - {material.subject?.subject_name}</p>
                            </div>
                            <div className="col-span-2">
                                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Description</label>
                                <p className="text-gray-900 dark:text-white font-medium mt-1">{material.description || 'No description'}</p>
                            </div>
                            <div>
                                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">File Size</label>
                                <p className="text-gray-900 dark:text-white font-medium mt-1">{formatFileSize(material.file_size)}</p>
                            </div>
                            <div>
                                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Uploaded</label>
                                <p className="text-gray-900 dark:text-white font-medium mt-1">{new Date(material.created_at).toLocaleDateString()}</p>
                            </div>
                            <div>
                                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Uploader</label>
                                <p className="text-gray-900 dark:text-white font-medium mt-1">{material.uploader?.name || 'Unknown'}</p>
                            </div>
                        </div>
            ...
            <div className="flex min-h-full items-center justify-center p-4">
                ...
                <div className="relative w-full max-w-xl transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-2xl transition-all">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6 dark:bg-gray-800">
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Subject <span className="text-red-500">*</span></label>
                            <select
                                name="subject_id"
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Material Title <span className="text-red-500">*</span></label>
                            <input
                                type="text"
                                name="title"
                        ...
                        {isNew && (
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Upload File <span className="text-red-500">*</span></label>
                                <input
                                    type="file"
                                    name="file"
                                    ref={fileInputRef}
                                    onChange={handleChange}
                                    className={`w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 ${RING_COLOR_CLASS} focus:border-transparent transition-all file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-blue-900/30 file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100 dark:hover:file:bg-blue-900/50 bg-white dark:bg-gray-700`}
                                    required={isNew}
                                />
                                {formData.file && (<p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Selected: {formData.file.name}</p>)}
                ...
                <div className="container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
                    <div className="mb-4 sm:mb-6 md:mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
                        <div className="flex items-center mb-4 sm:mb-6 md:mb-0">
                            ...
                            <div>
                                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Course Materials</h1>
                                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-0.5 sm:mt-1">Manage learning resources by subject</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead className={`${PRIMARY_COLOR_CLASS}`}>
                                    <tr>
                                        <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap">Material</th>
                                        ...
                                        <th className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap">Description</th>
                                        <th className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap">File Size</th>
                                        <th className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap">Uploaded</th>
                                        ...
                                        <tr>
                                            <td colSpan={6} className="px-3 sm:px-6 py-8 sm:py-12 text-center text-gray-500 dark:text-gray-400">
                                                <div className="flex flex-col items-center">
                                                    <FileText className="h-10 w-10 sm:h-12 sm:w-12 text-gray-300 dark:text-gray-600 mb-3 sm:mb-4" />
                                                    <p className="text-base sm:text-lg font-medium dark:text-white">No course materials found</p>
                                                    <p className="text-xs sm:text-sm dark:text-gray-400">Upload a new material or adjust filters</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : (
                                                    ...
                                                    <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4">
                                                        <div className="flex items-center">
                                                            <div className={`p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 ${LIGHT_BG_CLASS} dark:bg-gray-700`}>
                                                                <IconComponent className={`h-4 w-4 sm:h-5 sm:w-5 ${TEXT_COLOR_CLASS} dark:text-white`} />
                                                            </div>
                                                            <div className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white truncate">{material.title}</div>
                                                        </div>
                                                        {/* Show additional info on mobile */}
                                                        <div className="md:hidden mt-1 space-y-1">
                                                            <div className="text-xs text-gray-600 dark:text-gray-400">{material.subject?.subject_code} - {material.subject?.subject_name}</div>
                                                            <div className="text-xs text-gray-500 dark:text-gray-400 truncate">{material.description || '-'}</div>
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-xs text-gray-600 dark:text-gray-400">{formatFileSize(material.file_size)}</span>
                                                                <span className="text-xs text-gray-600 dark:text-gray-400">•</span>
                                                                <span className="text-xs text-gray-600 dark:text-gray-400">{new Date(material.created_at).toLocaleDateString()}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
                                                        <div className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{material.subject?.subject_code}</div>
                                                        <div className="text-xs text-gray-500 dark:text-gray-400">{material.subject?.subject_name}</div>
                                                    </td>
                                                    <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-700 dark:text-gray-300 max-w-xs truncate" title={material.description || 'N/A'}>
                                                        {material.description || '-'}
                                                    </td>
                                                    <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                                                        {formatFileSize(material.file_size)}
                                                    </td>
                                                    <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
                                                        <div className="text-xs sm:text-sm text-gray-700 dark:text-white">{new Date(material.created_at).toLocaleDateString()}</div>
                                                        <div className="text-xs text-gray-500 dark:text-gray-400">{material.uploader?.name || 'Unknown'}</div>
                                                    </td>
